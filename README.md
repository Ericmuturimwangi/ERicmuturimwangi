...
-  **Fun fact**: I love blending security principles with innovative coding to create real-world impact.
...
|-----------------------|---------------------|--------------------|-----------------------------------|
| Python, Django        | Vue  , HTMX         | PostgreSQL, SQLite | Docker, Git, Linux                |
| Laravel, PHP          | JavaScript, CSS     | MySQL, MariaDB     | cPanel, SSL Certs ,WHM management |
...
- [LinkedIn](www.linkedin.com/in/eric-muturi-24768816a)
- [Twitter](https://twitter.com/your-twitter)
- [Personal Website](https://ericmuturimwangi.netlify.app/)
